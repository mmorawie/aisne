...
Panel::Panel(QWidget * parent, Font * fnt, Fdtd * nfdtd) : GLComponent(parent, fnt){
...
void Panel::line(int x1, int y1, int x2, int y2){
...
void Panel::hmark(int x, int nbr){
...
void Panel::write_to_file(char * filename){
...
void Panel::save_pattern(char * filename, double treshold){
ofstream file (filename);
	double epsilon;
